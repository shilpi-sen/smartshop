...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'smartshop' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'smartshop' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'smartshop' ),
		'repeat'    => esc_html__( 'Repeat All', 'smartshop' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'smartshop' ),
		'top center'    => esc_html__( 'Top Center', 'smartshop' ),
		'top right'     => esc_html__( 'Top Right', 'smartshop' ),
		'center left'   => esc_html__( 'Middle Left', 'smartshop' ),
		'center center' => esc_html__( 'Middle Center', 'smartshop' ),
		'center right'  => esc_html__( 'Middle Right', 'smartshop' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'smartshop' ),
		'bottom center' => esc_html__( 'Bottom Center', 'smartshop' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'smartshop')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'smartshop' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'smartshop')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'smartshop' ),
		'italic'      => esc_html__( 'Italic', 'smartshop' ),
		'bold'        => esc_html__( 'Bold', 'smartshop' ),
		'bold italic' => esc_html__( 'Bold Italic', 'smartshop' )
		);
